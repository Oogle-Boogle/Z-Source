...
public class Scoreboards {
	...
	public static void init() {
		TOP_PKERS = new Scoreboard("Zamron's Top Pkers", "top-pkers.txt") {
			@Override
		...
		TOP_NPC_KILLCOUNT = new Scoreboard("Zamron's Top Npc Killcount", "top-killstreaks.txt") {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
		...
		TOP_ACHIEVER = new Scoreboard("Zamron's Top Achiever", "top-achievers.txt")  {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
				Scoreboards.resort(entries, "integer");
			}
		...
		TOP_TOTAL_EXP = new Scoreboard("Zamron's Top Total Exp", "top-exp.txt")  {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
