...
public class TheDeath extends NPC {
	public static Item[] COMMONLOOT = { new Item(10835, 5000) };
	 ...
	 */
	public static final TheDeathLocation[] LOCATIONS = { new TheDeathLocation(3038, 5345, 0, " ::death") };

	/**
	 *
	 */
	private static TheDeath current;

	/**
	 *
	 * @param position
	 */
	public TheDeath(Position position) {
	...
	public static void spawn() {
		...
		TheDeathLocation location = Misc.randomElement(LOCATIONS);
		TheDeath instance = new TheDeath(location.copy());

		// //System.out.println(instance.getPosition());

		World.register(instance);
		setCurrent(instance);
		System.out.print("Death has spawned.");

		World.sendMessageDiscord("<shad=1><img=418>@red@Death has respawned " +location.getLocation() + "");
	}
	 ...
	 * @return
	 */
	public static TheDeath getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(TheDeath current) {
		TheDeath.current = current;
	}
	 ...
	 *
	 */
	public static class TheDeathLocation extends Position {
		 ...
		 * @param location
		 */
		public TheDeathLocation(int x, int y, int z, String location) {
			super(x, y, z);
